          ...
          <>
            ...
            <section className="mt-5 grid gap-5 lg:grid-cols-[0.7fr_1.3fr]">
              <div className="space-y-5">
                <div className="rounded-2xl border border-border bg-card p-5"><h2 className="font-bold">My Profile</h2><dl className="mt-4 grid gap-3 text-sm"><div><dt className="text-muted-foreground">Roll number</dt><dd className="font-medium">{profile.roll_number}</dd></div><div><dt className="text-muted-foreground">Branch</dt><dd className="font-medium">{profile.branch ?? "—"}</dd></div><div><dt className="text-muted-foreground">Email</dt><dd className="font-medium">{profile.email}</dd></div><div><dt className="text-muted-foreground">Phone</dt><dd className="font-medium">{profile.contact_number}</dd></div><div><dt className="text-muted-foreground">Average</dt><dd className="font-medium">{profile.average_percentage ?? "—"}%</dd></div><div><dt className="text-muted-foreground">Total backlogs</dt><dd className="font-medium">{profile.total_reappears}</dd></div><div><dt className="text-muted-foreground">Aadhaar</dt><dd className="font-medium">XXXX-XXXX-{profile.aadhaar_number?.slice(-4) ?? "XXXX"}</dd></div></dl></div>

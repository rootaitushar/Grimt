ALTER TABLE public.placement_students
  ADD COLUMN semester_1_status TEXT,
  ADD COLUMN semester_2_status TEXT,
  ADD COLUMN semester_3_status TEXT,
  ADD COLUMN semester_4_status TEXT,
  ADD COLUMN semester_5_status TEXT,
  ADD COLUMN semester_6_status TEXT,
  ADD COLUMN semester_7_status TEXT;
...
ALTER TABLE public.placement_students
  ADD CONSTRAINT placement_students_semester_statuses_valid CHECK (
    ...
    AND semester_6_status IS NOT NULL AND semester_6_status IN ('Clear', 'Backlog', 'Result Awaited')
    AND semester_7_status IS NOT NULL AND semester_7_status IN ('Clear', 'Backlog', 'Result Awaited')
...
COMMENT ON COLUMN public.placement_students.mother_phone IS
  'Legacy field; no longer collected by the current student form.';
